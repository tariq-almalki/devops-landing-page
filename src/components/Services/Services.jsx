        ...
        >
            <main className={classes.main}>
                ...
                <div className={classes.div1}>
                    <a href={props.services[0].url} className={classes.a1} target='_blank' rel='noreferrer'>
                ...
                <div className={classes.div2}>
                    <a href={props.services[1].url} className={classes.a2} target='_blank' rel='noreferrer'>
                ...
                <div className={classes.div3}>
                    <a href={props.services[2].url} className={classes.a3} target='_blank' rel='noreferrer'>
